...
abstract class Model {
	...
	public function __construct($dbIndex=''){
		...
		array_walk_recursive($_GET, array($this, 'array_escaping'));
		array_walk_recursive($_POST, array($this, 'array_escaping'));
		array_walk_recursive($_REQUEST, array($this, 'array_escaping'));
	}
